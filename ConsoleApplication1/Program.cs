namespace ConsoleApplication1
{
	...
	internal class Program
	{
		...
		{
			var connectionString = "metadata=res://*/Model1.csdl|res://*/Model1.ssdl|res://*/Model1.msl;provider=System.Data.SQLite.EF6;provider connection string='data source=\"test.db3\"'";

			using (var model = new testEntities(connectionString))
			{
	...
	{
		public testEntities(string connection)
			: base(connection)
		{
		}
	}
